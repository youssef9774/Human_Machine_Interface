...
"font: 75 8pt \"Script MT Bold\";")
        ...
        self.loginbut.setGeometry(QtCore.QRect(140, 360, 91, 31))
...
"background-color: rgb(167, 168, 167);")
        ...
        self.alert_line = QtWidgets.QLabel(self.centralwidget)
        self.alert_line.setGeometry(QtCore.QRect(10, 320, 381, 31))
        self.alert_line.setStyleSheet("color: rgb(255, 0, 0);\n"
"font: 16pt \"MS Shell Dlg 2\";")
        self.alert_line.setText("")
        self.alert_line.setObjectName("alert_line")
    ...
    def retranslateUi(self, MainWindow):
        ...
        # donner l'action pour le boutton pour acceder à la fonction callback Authentification
        self.loginbut.clicked.connect(self.Authentification)
        
    
    #fonction call back pour 1er : verification des mdp et identifiant 2eme : si il est correct il passe pour la deuxiem fenetre
    def Authentification(self):
        ...
        if a == host and b == mdp:
            ...
            c = "Resseyer mdp ou identifant incorect"
            user = self.username.text()
            mdp = self.password.text()        
            print(user,mdp)
            self.alert_line.setText(c)
            self.username.clear()
            self.password.clear()
...
if __name__ == "__main__": # C'est variables spéciales  qui protège les utilisateurs contre l'invocation accidentelle du script alors qu'ils n'avaient pas l'intention de le faire
